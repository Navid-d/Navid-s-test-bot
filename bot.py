...
@bot.message_handler(func=lambda m: True if m.text != None and ("پی وی" in m.text or "pv" in m.text or "p v" in m.text or "پیوی" in m.text) and "بیا" in m.text else False)
def pv(message):
